...
Locator: locator('h1')
Expected substring: "Plan your perfect trip"
Received string:    "CPE Intelligence"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('h1')
    9 × locator resolved to <h1 class="login-title">CPE Intelligence</h1>
      - unexpected value "CPE Intelligence"
...
> 8  |   await expect(page.locator('h1')).toContainText('Plan your perfect trip');
     |                                    ^ Error: expect(locator).toContainText(expected) failed
  9  | 
